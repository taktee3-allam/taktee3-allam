...
class GPT3QAModel(BaseQAModel):
    def __init__(self, model="text-davinci-003"):
        ...
        """
        self.model = model
        self.client = OpenAI(api_key="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")
